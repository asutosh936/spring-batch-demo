...
* The original package name 'com.spring.batch.learn.spring-batch-demo' is invalid and this project uses 'com.spring.batch.learn.spring_batch_demo' instead.
...
* [Spring Batch](https://docs.spring.io/spring-boot/3.5.8/how-to/batch.html)
